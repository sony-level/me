...
<br ></br>
  ...
  pouvant donner suite à une possibilité de poursuivre un <b className="font-medium text-blue-500">contrat de professionnalisation</b> dès <b className="font-medium text-blue-500">octobre 2024 😊</b> .
</p>
<br ></br>
       <p className="mb-3">   
       <SectionHeading>Hobbies</SectionHeading>
            <i className="italic">👨‍💻 A mes heures libres</i>, je developpe de petite application simple pour apprendre, regarder des documentaires 🎬,  participer aux CTF (Capture The Flag) 🏁 afin de m'améliorer.  J'aime aussi{" "}
